  ...
  return (
    <>
      ...
      {!isOpen && (
        <>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="fixed bottom-16 md:bottom-6 right-20 md:right-24 z-[88888888] group"
          >
          ...
          <button
            ...
            className="fixed bottom-16 md:bottom-6 right-2 md:right-4 z-[88888888] group"
          >
          <div className="relative">
      ...
      {isOpen && isLoading && (
        <div
          className={cn(
            "fixed z-[88888888] bg-card border border-border shadow-2xl transition-all duration-300",
