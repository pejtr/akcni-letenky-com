  ...
  return (
    ...
    >
      <div className="container flex items-center justify-between gap-4">
        {/* Logo */}
        <Link href="/">
          <a className="flex items-center gap-1.5 hover:opacity-90 transition-opacity flex-shrink-0">
            <img
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          {/* Wishlist */}
          <Link href="/wishlist">
            <a className="relative p-2 text-gray-500 hover:text-[#E91E63] transition-colors" aria-label="Oblíbené">
