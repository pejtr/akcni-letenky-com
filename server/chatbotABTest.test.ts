...
describe("Chatbot A/B Test Personas", () => {
  describe("Persona Definitions", () => {
    ...
    it("should have Petra with energetic tone", () => {
      expect(PERSONA_PHOEBE.name).toBe("petra");
    ...
    it("should have Monika with professional tone", () => {
      expect(PERSONA_PIPER.name).toBe("monika");
    ...
    it("Petra greeting should contain multiple emojis", () => {
  ...
  describe("Persona System Prompts", () => {
    it("Petra system prompt should mention energetic personality", () => {
      expect(PERSONA_PHOEBE.systemPromptAddition.toLowerCase()).toContain("energi");
    });

    it("Monika system prompt should mention professional personality", () => {
  ...
  describe("Target Audiences", () => {
    it("Petra should target younger audience", () => {
      expect(PERSONA_PHOEBE.targetAudience.toLowerCase()).toContain("mlad");
    });

    it("Monika should target middle-aged audience", () => {
